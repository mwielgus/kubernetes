...
var podTemplateColumns = []funcColumnPrinter{
	...
	{title: "PODLABELS", content: func(pod *api.PodTemplate) string { return labels.FormatLabels(pod.Template.Labels) }},
}
...
var replicationControllerColumns = []funcColumnPrinter{
	...
	{title: "SELECTOR", content: func(rc *api.ReplicationController) string { return labels.FormatLabels(rc.Spec.Selector) }},
...
var serviceColumns = []funcColumnPrinter{
	...
	{title: "SELECTOR", content: func(s *api.Service) string { return labels.FormatLabels(s.Spec.Selector) }},
	ageColumn,
}
...
var nodeColumns = []funcColumnPrinter{
	noNamespaceColumn,
	makeNameColumn("NAME"),
	{title: "LABELS", content: func(node *api.Node) string { return labels.FormatLabels(node.Labels) }},
...
var namespaceColumns = []funcColumnPrinter{
	noNamespaceColumn,
	makeNameColumn("NAME"),
	{title: "LABELS", content: func(n *api.Namespace) string { return labels.FormatLabels(n.Labels) }},
...
var persistentVolumeColumns = []funcColumnPrinter{
	noNamespaceColumn,
	makeNameColumn("NAME"),
	{title: "LABELS", content: func(p *api.PersistentVolume) string { return labels.FormatLabels(p.Labels) }},
...
var persistentVolumeClaimColumns = []funcColumnPrinter{
	...
	{title: "LABELS", content: func(p *api.PersistentVolumeClaim) string { return labels.FormatLabels(p.Labels) }},
